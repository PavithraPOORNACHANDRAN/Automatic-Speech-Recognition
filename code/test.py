...
# train_df = pd.read_csv("dev_addf16_10db_keras.csv", nrows=1000)
# train_df = pd.read_csv("train1000_keras_aclm.csv", nrows=nbtrainpairs)
# train_df = pd.read_csv("train500_bertkeras_aclms_cmpwithbesthypo.csv")
train_df = pd.read_csv("train20.csv")
valid_df = pd.read_csv("train20.csv")
test_df = pd.read_csv("train20.csv")
